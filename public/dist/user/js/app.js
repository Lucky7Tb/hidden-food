...
var supabase = __webpack_require__(/*! ./supabase */ "./resources/js/supabase.js");

window.addEventListener('DOMContentLoaded', function () {
  var formUpload = document.getElementById("formUpload");
  var fileUpload = document.getElementById("image");
  formUpload.addEventListener("submit", function (e) {
    e.preventDefault(); // const file = fileUpload.files[0];
    // uploadFile(file);
...
function _downloadFile() {
  _downloadFile = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return supabase.storage.from("hidden-food-picture").download("tes.png");
...
function _uploadFile() {
  _uploadFile = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2(file) {
    var _yield$supabase$stora2, data, error;
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return supabase.storage.from("hidden-food-picture").upload("tes.png", file, {
              cacheControl: "3600",
              upsert: false
            });

          case 2:
            _yield$supabase$stora2 = _context2.sent;
